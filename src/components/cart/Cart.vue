<template>
  <div>
    <!-- <header class="pub-header">
      <span class="header-content">购物车</span>
    </header> -->
    <div class="scroll">
      <div class="block">
        <table class="addr-table">
          ...
          <tr>
            ...
            <td style="font-weight: 700">西安雁塔区长江路563号</td>
          </tr>
          </tbody>
        </table>
      </div>
...
export default {
  created () {
    ...
    this.$http
      .get(`/api/home?_r=0.10487448529559651&cart_pids=${encodeURIComponent(ids)}&location=121.5721941391567%2C31.21168025925351`)
      .then(res => {
